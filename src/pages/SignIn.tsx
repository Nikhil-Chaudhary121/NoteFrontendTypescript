...
const SignUpForm = () => {
  const [name ] = useState("Jonas Khanwald");
  const [dob] = useState("11 December 1997");
  ...
  // Auth hook
  const { handleLogin } = useAuth(name, dob, email, otp, rememberMe, isVerified);
            ...
            <div className="space-y-6">
              ...
              {otpVisible && (
                <div className="relative">
                  ...
                  <button onClick={handleGetOtp}  className=" mx-2 my-1 text-blue-400 underline font-medium">
                  Resend Otp
              </button>
                </div>
              )}
